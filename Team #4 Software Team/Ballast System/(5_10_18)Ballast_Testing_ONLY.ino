...
int solenoidInPin = 0; //will eventually be set to pin 1;
int solenoidOutPin = 0; //will eventually be set to pin 2;
...
void loop() 
{
  ...
  */
  ...
  if(missionEnd) //(missionTest) //if sub is signaled to rise to surface, allow air to enter
  {
    solenoidInPin = 1;
    solenoidOutPin = 2;
